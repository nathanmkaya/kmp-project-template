 ...
 */
import dev.nathanmkaya.template.AppBuildType
import dev.nathanmkaya.template.dynamicVersion
...
android {
    namespace = "dev.nathanmkaya.template"

    defaultConfig {
        applicationId = "dev.nathanmkaya.template"
...
dependencies {
    implementation(projects.templateShared)
