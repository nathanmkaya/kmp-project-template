...
fun TemplateScaffold(
    ...
    pullToRefreshState: TemplatePullToRefreshState = rememberTemplatePullToRefreshState(),
...
data class TemplatePullToRefreshState(
...
@Composable
fun rememberTemplatePullToRefreshState(
    isEnabled: Boolean = false,
    isRefreshing: Boolean = false,
    onRefresh: () -> Unit = { },
): TemplatePullToRefreshState = remember(isEnabled, isRefreshing, onRefresh) {
    TemplatePullToRefreshState(
        isEnabled = isEnabled,
