 ...
 */
package dev.nathanmkaya.template.core.designsystem.component
...
import dev.nathanmkaya.template.core.designsystem.utils.nonLetterColorVisualTransformation
import dev.nathanmkaya.template.core.designsystem.utils.tabNavigation

@Composable
fun TemplatePasswordField(
    label: String,
    value: String,
...
@Preview
@Composable
private fun TemplatePasswordField_preview_withInput_hidePassword() {
    TemplatePasswordField(
        label = "Label",
        value = "Password",
        onValueChange = {},
...
@Preview
@Composable
private fun TemplatePasswordField_preview_withInput_showPassword() {
    TemplatePasswordField(
        label = "Label",
        value = "Password",
        onValueChange = {},
...
@Preview
@Composable
private fun TemplatePasswordField_preview_withoutInput_hidePassword() {
    TemplatePasswordField(
        label = "Label",
        value = "",
        onValueChange = {},
...
@Preview
@Composable
private fun TemplatePasswordField_preview_withoutInput_showPassword() {
    TemplatePasswordField(
        label = "Label",
        value = "",
        onValueChange = {},
