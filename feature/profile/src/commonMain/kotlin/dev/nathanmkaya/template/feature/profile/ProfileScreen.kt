 ...
 */
package dev.nathanmkaya.template.feature.profile
...
import dev.nathanmkaya.template.core.designsystem.component.TemplateScaffold
...
internal fun ProfileScreenContent(modifier: Modifier) {
    TemplateScaffold(modifier = modifier) {
        Column(
            modifier = Modifier
                .fillMaxSize()
                .padding(it),
